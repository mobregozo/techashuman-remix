  ...
  return (
    <article>
      ...
      <div className="mt-4 mb-8">
        <a
          className="flex max-w-fit transform items-center space-x-2 rounded-md border border-primary-700 px-6 py-2 transition-all duration-300 ease-in-out hover:scale-105 hover:bg-secondary dark:border-white"
      ...
      <p className="mt-2 text-gray-500 text-sm">Image generated by ChatGPT</p>

      <h2 className="mt-8 mb-6 font-semibold text-3xl text-primary-700 tracking-tighter dark:text-secondary-400">
      ...
      <h2 className="mt-4 mb-6 font-semibold text-3xl text-primary-700 tracking-tighter dark:text-secondary-400">
      ...
      <h3 className="mt-8 mb-2 font-bold text-2xl">Why Remix?</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-2xl">Content management</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-2xl">Why Plausible?</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-2xl">Why Tailwind?</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-2xl">Using Copilot and OpenAI</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-2xl">Why Substack?</h3>
      <p>
