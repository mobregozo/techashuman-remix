export default function AboutBlog() {
  return (
    <div className="max-w-2xl text-gray-600 dark:text-gray-200">
      ...
      <p>
        Remix stood out because it challenges conventional web
        development patterns and allows for flexible deployments without being
        tied to a specific hosting company.
      </p>
      <p>
