export default function AboutBlog() {
  return (
    <div className="max-w-2xl text-gray-600 dark:text-gray-200">
      <h1 className="text-5xl text-primary-700 font-bold dark:text-secondary-400 tracking-tighter mb-6">
        About Tech as Human
      </h1>

      <div className="mt-4 mb-8">
        <a
          className="px-6 py-2 flex max-w-fit items-center space-x-2 hover:bg-secondary rounded-md border border-primary-700 dark:border-white hover:scale-105 transform transition-all duration-300 ease-in-out"
      ...
      <p className="text-sm text-gray-500 mt-2">Image generated by ChatGPT</p>

      <h2 className="text-3xl text-primary-700 dark:text-secondary-400 tracking-tighter mb-6 font-semibold mt-8">
      ...
      <h2 className="text-3xl text-primary-700 dark:text-secondary-400 tracking-tighter mt-4 mb-6 font-semibold">
        The Tech Stack Behind Tech as Human
      </h2>

      <h3 className="mt-8 mb-2 font-bold text-xl">
        CRM and Content Management
      </h3>
      <p>
        Initially, I experimented with different methods of managing my content,
        including static JSON files, Markdown, and Prismic. However, I settled
        on Notion for its portability and flexibility. I love how Notion's API
        allows me to structure posts exactly as I want them, making the content
      ...
      <h3 className="mt-8 mb-2 font-bold text-xl">Tech Stack Choices</h3>
      <p>
        ...
        Next.js, and eventually landed on Remix. Remix stood out because it
        challenges conventional web development patterns and allows for flexible
        deployments without being tied to a specific hosting company.
      </p>

      <h3 className="mt-8 mb-2 font-bold text-xl">Why Plausible?</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-xl">Why Tailwind?</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-xl">Using Copilot and OpenAI</h3>
      <p>
      ...
      <h3 className="mt-8 mb-2 font-bold text-xl">Why Substack?</h3>
      <p>
