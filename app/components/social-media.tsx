    ...
    <li className="flex">
      ...
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          className="group-hover:fill-primary-600 h-6 w-6 flex-none fill-zinc-500 transition"
        >
    ...
    <li className="flex">
      ...
      >
        <svg
          ...
          strokeWidth="1.8"
          stroke="none"
          className="group-hover:fill-primary-700 h-6 w-6 flex-none fill-zinc-500 p-0.5 transition"
